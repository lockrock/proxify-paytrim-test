...
function mapToInputStatus(input: {
  isTouched: boolean;
  isValid: boolean;
}): 'correct' | 'error' | undefined {
  if (input.isValid && input.isTouched) return 'correct';
  if (!input.isValid && !input.isTouched) return undefined;
  return 'error';
}
